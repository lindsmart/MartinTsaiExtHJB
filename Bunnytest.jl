...
function mainBunny(N,nitrs,Q::Array{Float64},nT,T);
...
function mainBunny2pts(N,nitrs,Q::Array{Float64},nT1,T1,nT2,T2);
...
nT1=get_variable(mf, "nT1Bunny")
T1=get_variable(mf, "T1Bunny")
#nT2=get_variable(mf, "nT3Bunny")
#T2=get_variable(mf, "T3Bunny")

close(mf)

@time Uvals,U,V,W=mainBunny(201,80,Q,nT1,T1);
#@time Uvals,U,V,W=mainBunny2pts(201,100,Q,nT1,T1,nT2,T2);
